...
set_or_remove_like_by_author = SetCommentLikeByAuthorView.as_view({'post': 'set_or_remove_like_by_author'})
...
urlpatterns = [
    ...
    path('profile/<slug:username>/notification/list/', notification_list, name='notification_list'),

    path('<slug:username>/subscriptions/', user_subscriptions, name='user_subscriptions'),

    path('blog/<slug:slug>/post/<int:post_id>/like/', set_or_remove_like, name='set_or_remove_like'),
    path('blog/<slug:slug>/post/<int:post_id>/dislike/', set_or_remove_dislike, name='set_or_remove_dislike'),
    path('blog/<slug:slug>/post/<int:post_id>/bookmark/', add_or_remove_bookmark, name='add_or_remove_bookmark'),
    ...
    path('blog/<slug:slug>/post/<int:post_id>/comment/list/reply/', post_comment_list_reply, name='post_comment_list_reply'),
    path('blog/<slug:slug>/post/<int:post_id>/comment/<int:comment_id>/pin/', pin_comment, name='pin_comment'),
    ...
    path('notification/<int:pk>/is_read/', read_notification, name='notification_is_read'),
